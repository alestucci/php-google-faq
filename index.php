...
<body>
    <main>
            ...
            [
                ...
                <ol>
                    <li>The Google affiliate that provides the services, that processes your information, and that is responsible for complying with applicable privacy laws. Generally, Google offers its consumer services through either of two companies:
                        <ol>
                            <li class="letters">Google Ireland Limited, if you’re located in the European Economic Area (EU countries plus Iceland, Liechtenstein, and Norway) or Switzerland</li>
                            <li class="letters">Google LLC, based in the United States, for the rest of the world</li>
                        </ol>
                    </li>
                ...
                'sub_question' => 'Determining the country associated with your account',
                'sub_answer' => '<p>When you create a new account, we associate your account with a country based on where you created your Google Account. For accounts at least a year old, we use the country from which you usually access Google services — typically where you’ve spent the most time in the last year.</p>
        ...
        foreach ($faq_array as $faq) {
            ...
            echo $faq['answer'];
            echo ($faq['sub_question'] !== null) ? '<h3>' . $faq['sub_question'] . '</h3>' : '';
            echo ($faq['sub_answer'] !== null) ? $faq['sub_answer'] : '';
        };
        ?>
    </main>
</body>
